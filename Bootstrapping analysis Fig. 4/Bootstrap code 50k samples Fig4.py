...
def Linear_regression_bootstrap_coordinates(axis1, axis2, axis, nZones, nShuffles):
    ...
    file = '3d coordinates_all75cells_originalcoords.csv'
    ...
    ### All coordinates in np array format 
    ...
    if nZones == "n4":
        if axis == "xy":
            ...
            for i in range(nShuffles):
                ...
                #print(sample_of_3_i_xy_linear_reg_stats)
                #print(sample_of_3_i_xy)
            ...
            for i in range(nShuffles):   
             ...
             #print(samples_of_3_nShuffles_times)
        ...
        if axis == "xy":
            ...
            for i in range(nShuffles):
                ...
                #print(sample_of_6_i_xy_linear_reg_stats)
                #print(sample_of_6_i_xy)
            ...
            for i in range(nShuffles):
                ...
                #print(sample_of_6_i_xz_linear_reg_stats)
                #print(sample_of_6_i_xz)
            ...
            for i in range(nShuffles):
                ...
                #print(sample_of_6_i_yz_linear_reg_stats)
                #print(sample_of_6_i_yz)
        ...
        if axis == "xy":
            ...
            for i in range(nShuffles):
                ...
                #print(sample_of_26_i_xy_linear_reg_stats)
                #print(sample_of_26_i_xy)
            ...
            for i in range (nShuffles):
                ...
                #print(sample_of_26_i_xz_linear_reg_stats)
                #print(sample_of_26_i_xz)
            ...
            for i in range(nShuffles):
                ...
                #print(sample_of_26_i_yz_linear_reg_stats)
                #print(sample_of_26_i_yz)
        ...
        if axis == "xy":
            ...
            for i in range(nShuffles):
                    ...
                    #print(sample_of_34_i_xy_linear_reg_stats)
                    #print(sample_of_34_i_xy)
            ...
            for i in range(nShuffles):
                    ...
                    #print(sample_of_34_i_xz_linear_reg_stats)
                    #print(sample_of_34_i_xz)
            ...
            for i in range(nShuffles):
                ...
                #print(sample_of_34_i_yz_linear_reg_stats)
                    #print(sample_of_34_i_yz)
         ...
         #print(samples_of_34_nShuffles_times)
