...
def create_point(x, y, z, zones): 
    ...
    if type(zones) == str:
        if zones == "None":
            ...
            return new_cell
        if zones == "Anterior":
            new_cell = Point(cell_coords, color="#FFFFFF", radius=20, alpha=1)
            zonal_colors["Anterior"] = "#FFFFFF"
        ...
        new_cell = Point(cell_coords, color="black", radius=20, alpha=1)
        ...
        if "Anterior" not in zones:
            new_cell = Point(cell_coords, color="#727272", radius=20, alpha=1)
            zonal_colors["Central, Posterior, Nodular"] = "#727272"
            ...
            new_cell = Point(cell_coords, color="#727272", radius=20, alpha=1)
            zonal_colors["Anterior, Posterior, Nodular"] = "#727272"
            ...
            new_cell = Point(cell_coords, color="#727272", radius=20, alpha=1)
            zonal_colors["Anterior, Central, Nodular"] = "#727272"
            ...
            new_cell = Point(cell_coords, color="#727272", radius=20, alpha=1)
            zonal_colors["Anterior, Central, Posterior"] = "#727272"
        ...
        if "Anterior" in zones and "Central" in zones: 
            new_cell = Point(cell_coords, color="#B2B2B2", radius=20, alpha=1)
            zonal_colors["Anterior, Central"] = "#B2B2B2"
            ...
            new_cell = Point(cell_coords, color="#B2B2B2", radius=20, alpha=1)
            zonal_colors["Anterior, Posterior"] = "#B2B2B2"
            ...
            new_cell = Point(cell_coords, color="B2B2B2", radius=20, alpha=1)
            zonal_colors["Anterior, Nodular"] = "B2B2B2"
            ...
            new_cell = Point(cell_coords, color="#B2B2B2", radius=20, alpha=1)
            zonal_colors["Central, Posterior"] = "#B2B2B2"
            ...
            new_cell = Point(cell_coords, color="#B2B2B2", radius=20, alpha=1)
            zonal_colors["Central, Nodular"] = "#B2B2B2"
            ...
            new_cell = Point(cell_coords, color="#B2B2B2", radius=20, alpha=1)
            zonal_colors["Posterior, Nodular"] = "#B2B2B2"
