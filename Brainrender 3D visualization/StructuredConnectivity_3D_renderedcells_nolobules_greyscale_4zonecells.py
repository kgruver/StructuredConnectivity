...
def create_point(x, y, z, zones): 
    cell_coords = [x, y, z]
    if "Anterior" in zones and "Central" in zones and "Posterior" in zones and "Nodular" in zones: 
...
fn_rendered = scene.add_brain_region('FN', alpha=0.1, color="grey", silhouette=True) #FN occasionally difficult to see without silhouette
