...
### Lobule 2 cells excluded since not every slice contained lobule 2 (more lateral slices did not contain it)
cell_connected_to_lobules = pd.read_csv ('Cell_connected_to_lobules_boolean_excluding_lobule2andNonecells.csv')
